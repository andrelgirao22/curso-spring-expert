package com.alg.brewer.model.validation.validator;
...
import com.alg.brewer.model.validation.AtributoConfirmacao;
...
public class AtributoConfirmacaoValidator implements ConstraintValidator<AtributoConfirmacao, Object>{
	...
	public boolean isValid(Object value, ConstraintValidatorContext context) {
		...
		try {			
			...
			throw new RuntimeException("Erro recuperando valores dos atributos");
		}
